...
const ProductCards = ({ loading, children, currentPage, setCurrentPage, currentProducts, limit, numberOfProducts }) => {
  ...
  if (loading) return (<div role="status  " className="flex-3 flex justify-center items-center">
    <svg aria-hidden="true" className="w-10 text-gray-200 animate-spin dark:text-gray-600 fill-purple-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
